...
#include "boingusconfigwidget.h"
#include "boingusexceptionlist.h"
...
namespace Boingus
{
    ...
    ConfigWidget::ConfigWidget( QWidget* parent, const QVariantList &args ):
        ...
        m_configuration( KSharedConfig::openConfig( QStringLiteral( "boingusrc" ) ) ),
        m_changed( false )
    {
    ...
    void ConfigWidget::save()
    {
        ...
        // needed for boingus style to reload shadows
        {
            QDBusMessage message( QDBusMessage::createSignal("/BoingusDecoration",  "org.kde.Boingus.Style", "reparseConfiguration") );
            QDBusConnection::sessionBus().send(message);
        }
