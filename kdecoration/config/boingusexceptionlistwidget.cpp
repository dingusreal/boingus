//////////////////////////////////////////////////////////////////////////////
// boingusexceptionlistwidget.cpp
// -------------------
//
...
#include "boingusexceptiondialog.h"
...
namespace Boingus
{
    ...
    void ExceptionListWidget::add()
    {
        ...
        dialog->setWindowTitle( i18n( "New Exception - Boingus Settings" ) );
    ...
    void ExceptionListWidget::edit()
    {
        ...
        // create dialog
        QPointer<ExceptionDialog> dialog( new ExceptionDialog( this ) );
        dialog->setWindowTitle( i18n( "Edit Exception - Boingus Settings" ) );
        dialog->setException( exception );
    ...
    void ExceptionListWidget::remove()
    {
        ...
        // confirmation dialog
        {
            QMessageBox messageBox( QMessageBox::Question, i18n("Question - Boingus Settings" ), i18n("Remove selected exception?"), QMessageBox::Yes | QMessageBox::Cancel );
    ...
    bool ExceptionListWidget::checkException( InternalSettingsPtr exception )
    {
        ...
        while( exception->exceptionPattern().isEmpty() || !QRegExp( exception->exceptionPattern() ).isValid() )
        {
            ...
            QMessageBox::warning( this, i18n( "Warning - Boingus Settings" ), i18n("Regular Expression syntax is incorrect") );
            QPointer<ExceptionDialog> dialog( new ExceptionDialog( this ) );
            dialog->setException( exception );
