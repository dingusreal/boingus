...
#ifndef boingusstyle_h
#define boingusstyle_h

#include "boingus.h"
#include "boingusmetrics.h"
#include "config-boingus.h"
#include "boingushelper.h"
...
namespace Boingus
{
    ...
    class Style: public ParentStyleClass
    {
        ...
        */
        ...
        //* tabbar data
        BoingusPrivate::TabBarData* _tabBarData = nullptr;
