...
#include "boingusanimations.h"
#include "boingusframeshadow.h"
#include "boingusmdiwindowshadow.h"
#include "boingusmnemonics.h"
#include "boinguspropertynames.h"
#include "boingusshadowhelper.h"
#include "boingussplitterproxy.h"
#include "boingusstyleconfigdata.h"
#include "boinguswidgetexplorer.h"
#include "boinguswindowmanager.h"
#include "boingusblurhelper.h"
#include "boingustoolsareamanager.h"
...
namespace BoingusPrivate
{
    ...
    class TabBarData: public QObject
    {
        ...
        Boingus::WeakPointer<const QWidget> _tabBar;
    ...
    class ComboBoxItemDelegate: public QItemDelegate
    {
        ...
        explicit ComboBoxItemDelegate( QAbstractItemView* parent ):
            ...
            _itemMargin( Boingus::Metrics::ItemView_ItemMarginWidth )
        {}
        ...
        //* proxy
        Boingus::WeakPointer<QAbstractItemDelegate> _proxy;
...
namespace Boingus
{
    ...
    Style::Style():
        ...
        , _tabBarData( new BoingusPrivate::TabBarData( this ) )
        #if BOINGUS_HAVE_KSTYLE
        ...
        #endif
    {
        ...
        dbus.connect( QString(),
            QStringLiteral( "/BoingusStyle" ),
            QStringLiteral( "org.kde.Boingus.Style" ),
            QStringLiteral( "reparseConfiguration" ), this, SLOT(configurationChanged()) );

        dbus.connect( QString(),
            QStringLiteral( "/BoingusDecoration" ),
            QStringLiteral( "org.kde.Boingus.Style" ),
            QStringLiteral( "reparseConfiguration" ), this, SLOT(configurationChanged()) );
    ...
    void Style::polish( QWidget* widget )
    {
        ...
        if( qobject_cast<QScrollBar*>( widget ) )
        {
            ...
            if( !hasParent( widget, "QWebView" ) )
            {
                ...
                { itemView->setItemDelegate( new BoingusPrivate::ComboBoxItemDelegate( itemView ) ); }
            }
    ...
    QRect Style::progressBarGrooveRect( const QStyleOption* option, const QWidget* widget ) const
    {
        ...
        const bool horizontal( BoingusPrivate::isProgressBarHorizontal( progressBarOption ) );
    ...
    QRect Style::toolButtonSubControlRect( const QStyleOptionComplex* option, SubControl subControl, const QWidget* widget ) const
    {
        ...
        const auto menuStyle = BoingusPrivate::toolButtonMenuArrowStyle( toolButtonOption );
        ...
        switch( subControl )
        {
            case SC_ToolButtonMenu:
            {
                ...
                // check features
                if( menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::None ) return QRect();

                // check features
                auto menuRect( rect );
                menuRect.setLeft( rect.right() - menuButtonWidth + 1 );
                if( menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::InlineSmall )
            ...
            case SC_ToolButton:
            {
                ...
                if( menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::SubControl )
                {
    ...
    QSize Style::toolButtonSizeFromContents( const QStyleOption* option, const QSize& contentsSize, const QWidget* ) const
    {
        ...
        const auto menuStyle = BoingusPrivate::toolButtonMenuArrowStyle( toolButtonOption );
        if( menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::InlineLarge )
        {
            size.rwidth() += Metrics::MenuButton_IndicatorWidth;
        }
    ...
    bool Style::drawIndicatorArrowPrimitive( ArrowOrientation orientation, const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        if( inTabBar ) {
            ...
            if( flat && menuStyle != BoingusPrivate::ToolButtonMenuArrowStyle::None )
            {
    ...
    bool Style::drawPanelButtonToolPrimitive( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        if( !autoRaise )
        {
            const auto menuStyle = BoingusPrivate::toolButtonMenuArrowStyle( option );
    ...
    bool Style::drawToolButtonComplexControl( const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        } else if( menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::InlineSmall
                   || menuStyle == BoingusPrivate::ToolButtonMenuArrowStyle::InlineLarge )
        {
