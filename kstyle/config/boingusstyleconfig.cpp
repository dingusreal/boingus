...
extern "C"
{
    ...
    { return new Boingus::StyleConfig(parent); }
}
...
namespace Boingus
{
    ...
    void StyleConfig::save()
    {
        ...
        // emit dbus signal
        QDBusMessage message( QDBusMessage::createSignal( QStringLiteral( "/BoingusStyle" ),  QStringLiteral( "org.kde.Boingus.Style" ), QStringLiteral( "reparseConfiguration" ) ) );
