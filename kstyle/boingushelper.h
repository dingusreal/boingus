...
#ifndef boingus_helper_h
#define boingus_helper_h
...
namespace Boingus
{
    ...
    //* boingus style helper class.
    /** contains utility functions used at multiple places in both boingus style and boingus window decoration */
